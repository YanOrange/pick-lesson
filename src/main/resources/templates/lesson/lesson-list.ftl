        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn layui-btn-danger" onclick="xadmin.open('新增','/page/addLesson',800,600)"
                            href="javascript:;">
            ...
            function () {
                ...
                table.render({
                    ...
                    cols: [[
                        ...
                        {field: 'name', title: '科目名', sort: true, width: 120},
                        {field: 'teacherName', title: '授课教师', sort: true, width: 120},
...
<script type="text/html" id="barTeacher">
    <a title="编辑" onclick="xadmin.open('编辑','/lesson/toEditLesson?lessonId={{d.id}}',800,600)" href="javascript:;">
