            ...
            function () {
                ...
                table.render({
                    ...
                    cols: [[
                        ...
                        {field: 'lessonClass', width: 80, title: '上课时间', sort: true,templet:'<div>{{d.lessonClass.doClassTime}}</div>'},
...
<script type="text/html" id="barTeacher">
    <a title="退课" onclick="pickLesson({{d.id}})" href="javascript:;">
        退课
    </a>
</script>
